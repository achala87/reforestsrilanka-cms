...
require_once 'homepagefiles/google/vendor/autoload.php';
require_once 'homepagefiles/google/vendor/googlesheetdata.php'; //gsheetid
  ...
  $client->setAuthConfig('homepagefiles/google/reforestwebsite-f4325a8b651f.json');
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="homepagefiles/main.css">
    ...
    <div class="container features">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <img src="homepagefiles/images/column-1.jpg" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <img src="homepagefiles/images/column-2.jpg" class="img-fluid">
...
?>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <img src="homepagefiles/images/profiles.jpg" class="img-fluid">
                <p>
    ...
    <div class="container cost">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 costoftrees">
                <img src="homepagefiles/images/tree.jpg" alt="cost of tree planting" />
            </div>
    ...
    <div class="container sponsor">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 costoftrees">
                <img src="homepagefiles/images/sponsors.jpg" class="img-fluid" alt="cost of tree planting" />
            </div>
    ...
    <div class="container volunteer">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 costoftrees">
                <img src="homepagefiles/images/volunteers.jpg" class="img-fluid" alt="cost of tree planting" />
            </div>
                ...
                <div class="panel panel-primary" id="result_panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="plantslider">
                            <div>
                                <h5>Mee</h5>
                                <img src="homepagefiles/images/mee.jpg" class="" alt="Mee tree">
                            ...
                            <div>
                                <h5>Kumbuk</h5>
                                <img src="homepagefiles/images/kumbuk.jpg" class="" alt="Kumbuk tree">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" class="btn btn-secondary 15ft" data-toggle="modal"
                            ...
                            <div>
                                <h5>Ahala</h5>
                                <img src="homepagefiles/images/ahala.jpg" class="" alt="Ahala tree">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" class="btn btn-secondary 15ft" data-toggle="modal"
                            ...
                            <div>
                                <h5>Karanda</h5>
                                <img src="homepagefiles/images/karanda.jpg" class="" alt="Karanda tree">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" class="btn btn-secondary 15ft" data-toggle="modal"
                            ...
                            <div>
                                <h5>Kohomba</h5>
                                <img src="homepagefiles/images/kohomba.jpg" class="" alt="Kohomba tree">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" class="btn btn-secondary 15ft" data-toggle="modal"
                            ...
                            <div>
                                <h5>Kos</h5>
                                <img src="homepagefiles/images/kos.jpg" class="" alt="Kos tree - jack fruit tree">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" class="btn btn-secondary 15ft" data-toggle="modal"
                            ...
                            <div>
                                <h5>Kon</h5>
                                <img src="homepagefiles/images/kon.jpg" class="" alt="Kon tree">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" class="btn btn-secondary 15ft " data-toggle="modal"
                        ...
                        <!-- Plant modal -->
                        <?php include 'homepagefiles/trees_include.php';?>
                        <!-- /Plant-modal -->
    ...
    <div class="container buymerchandise">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <img src="homepagefiles/images/reforest-tshirt-models.jpg" class="img-fluid">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <div class="tshirtslider">
                    ...
                    <div>
                        <img src="homepagefiles/images/tree.jpg" class="" alt="Reforest Sri Lanka Tshirt">
                    </div>
                    <div>
                        <img src="homepagefiles/images/tree.jpg" class="" alt="Reforest Sri Lanka Tshirt">
                    </div>
    ...
    <script src="homepagefiles/js/main.js"></script>
    ...
    $(document).ready(function() {
        ...
        $("#contactForm").submit(function(event) {
            ...
            if (userName != '' && userEmail != '' && msg != '') {
                ...
                var request = $.ajax({
                    url: "homepagefiles/sendmail.php",
                    type: "post",
                    data: serializedData
                });
